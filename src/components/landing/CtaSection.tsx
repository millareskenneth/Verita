...
export function CtaSection() {
  return (
    <section className={landingShellClass + " py-20"}>
      <Reveal>
        <div className="relative overflow-hidden rounded-2xl border border-primary/20 bg-linear-to-br from-primary/10 via-background to-background px-6 py-14 text-center sm:px-12">
